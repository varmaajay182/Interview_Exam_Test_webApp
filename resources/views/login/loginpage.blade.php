            ...
            <div class="row">
                <div class="col-12 col-md-6 bsb-tpl-bg-platinum">
                    <div class="d-flex flex-column justify-content-between h-100 p-3 p-md-4 p-xl-5">
                        ...
                        <img class="img-fluid rounded mx-auto my-4" loading="lazy"
                            src="{{ asset('img/login_img.jpg') }}" width="245" height="80"
                            alt="BootstrapBrain Logo">
                        <p class="mb-0">Not a member yet? <a href="/register"
                ...
                <div class="col-12 col-md-6 bsb-tpl-bg-lotion">
                    <div class="p-3 p-md-4 p-xl-5">
                        ...
                        <p class="" id="error">{{ Session::get('success') }}</p>
                        <script>
                            setTimeout(function() {
                    ...
                    @endif
                        @if (Session::has('errors'))
                            <p class="danger" id="error">{{ Session::get('errors') }}</p>
                            <script>
                                setTimeout(function() {
                                    document.getElementById('error').style.display = 'none';
                                }, 3000); // 5000 milliseconds (5 seconds) - adjust as needed
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="text-end">
                                    <a href="/forget_password" class="link-secondary text-decoration-none">Forgot password</a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="d-flex gap-3 flex-column flex-xl-row">
                                    <a href="/google/login" class="btn bsb-btn-xl btn-outline-primary">
